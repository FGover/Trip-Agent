...
class Attraction(BaseModel):
    ...
    cityname: str = Field("", description="AMap city name")
    adname: str = Field("", description="AMap administrative district name")
    adcode: str = Field("", description="AMap administrative district code")
    ...
    distance_from_previous_km: float | None = Field(default=None, description="距离上一站的路线距离，单位公里")
    duration_from_previous_minutes: float | None = Field(default=None, description="从上一站到本站的预计通勤时间，单位分钟")
    route_mode: str | None = Field(default=None, description="从上一站到本站的路径规划方式")
