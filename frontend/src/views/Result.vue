                    ...
                    <div class="activity-main">
                      ...
                      <div class="activity-info">
                        ...
                        <div class="activity-meta">
                          ...
                          <span v-if="attraction.distance_from_previous_km" class="duration">
                            上一站约 {{ attraction.distance_from_previous_km }} km / {{ attraction.duration_from_previous_minutes }} 分钟
                          </span>
                        </div>
                      </div>
                    </div>
                ...
                <div class="dining-content">
                  ...
                  <div class="dining-info">
                    ...
                    <div class="dining-meta">
                      ...
                      <span v-if="dining.distance_from_previous_km">
                        上一站约 {{ dining.distance_from_previous_km }} km / {{ dining.duration_from_previous_minutes }} 分钟
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div class="hotel-info">
                  ...
                  <div class="hotel-meta">
                    ...
                    <span class="hotel-price">
                      ...
                      <template v-else-if="hotel.price && hotel.price !== 'N/A'">
                        {{ hotel.price }}
                      </template>
                      <template v-else>
                        价格以平台为准
...
onMounted(async () => {
  const restoredTrip = tripStore.currentTrip ?? tripStore.hydrateCurrentTrip()
  if (!restoredTrip?.id) {
    return
  }

  try {
    const latestTrip = await tripApi.getTripDetail(restoredTrip.id)
    tripStore.setCurrentTrip(latestTrip)
    tripStore.upsertTrip(latestTrip)
  } catch (error) {
    console.warn('Failed to refresh trip detail:', error)
  }
})
